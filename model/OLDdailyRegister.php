 ...
 * all daily registration count  data of pillersmaker.
...
$sql = 'SELECT * FROM dailyregistration WHERE datetime =:dater';
...
if(!isset($result) || $result == false){
    ...
    $sql = "INSERT INTO `dailyregistration` (datetime, counter)  
...
if(isset($result)){    
    ...
    //exit();
    echo '2';
    $sql = "UPDATE `dailyregistration` SET counter =:counter WHERE datetime =:dater";
    $stmt = $pdo->prepare($sql);
