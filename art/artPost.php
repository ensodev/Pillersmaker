...
<?php
  ...
  require_once __DIR__ . '/../pagination/paginationCategory.php';
  require_once __DIR__ . '/../model/dailyPageView.php';
  
  
 
  $category = 'Art and Grahics';
  $databaseName = 'postworks';
  $rows = pagination($category, $databaseName);
...
<div class="container mb-3">
  ...
  <div class="row text-center">
    ...
    <div class="col-md-10 mt-3 w3-green p-3 text-right " id="styles">
      ...
      <span class=" w3-text-amber">OOO</span>  Art/Graphics Posts</h5>
     ...
     <div class=" w3-text-green w3-green p-2 w3-card-4" id="rady">
	...
	<div>      
      <div class=" w3-text-green w3-white p-1 w3-card-4" id="rady">
	<hr />
      <?php
        ...
        echo "
          <div class='alert w3-white text-left p-1 pl-3 mb-3 ml-3 mr-3'>
            ...
            <div class='col-md-1'>
              ...
              <h6 ><a class='w3-text-green' href='../view/viewPost.php?postid=$row->id&user_id=$row->user_id'>
          ";?>
      ...
      require_once __DIR__ . '/../pagination/paginationFooterArt.php';
