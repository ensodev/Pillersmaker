<?php 
            echo "<div class='m-5'><h4 class='w3-text-white'>";
              if(!isset($_GET["page"])){
                  ...
                  echo '<a href="fashionPost.php?page='. ($_GET["page"] - 1) .'"> << </a> ';
                  echo '</li>';
              }else{
                  $notset = 0;
              }
              ...
              for ($page = 1; $page <= $number_of_pages; $page++){
                 // echo '<a href="testPaginationPost.php?page='. $pages .'">'.$pages.'</a> ';
                  echo "<li class='page-item' style='display:inline-block'>";
                  echo "<a class='page-link' href='fashionPost.php?page= $page'>$page </a> ";
                  echo '</li>';
              ...
              if(!isset($_GET["page"])){
                  ...
                  //echo 'pagination';
                  echo "<li class='page-item' style='display:inline-block'>";
                  echo '<a href="fashionPost.php?page='. ($_GET["page"] + 2) .'"> >> </a> ';
                   echo '</li>';
                  //echo 'pagination';
