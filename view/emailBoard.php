                ...
                <div class='card mt-3 mb-3'>
                    <div class='card-header'> 
                        <div class="row pt-2 pl-3 text-center">   
                            ...
                            <a href="readMessages.php" class="menu "><span class="col-md-2">read<span></a> 
                        ...
                        echo "<br><div class='alert alert-danger'>   
                             Please delete some messages to allow new messages to show in your inbox...!
                        </div>";
                            }
                        ?>
                    </div>
                ...
                <div class='w3-white'>
                    ...
                    <div class='pl-2' Style='border-bottom:1px solid green' >
                        ...
                        <span class='w3-text-green p-1'>OOO</span>
                         <a Style='font-weight:bolder' href='/model/searchProfileProcess.php?id=                $result->sender_id'>{$result->user_name}
                        <span></a>
                        ...
                        echo "</small></span>
                            <a href='/model/markMessageReadProcess.php?id= {$result->msg_id}'class='w3-text-grean btn-sm '><span class=''>Mark Read</span>
                            <a class='  btn-sm w3-text-red 'href='/model/deleteMessageProcess.php?id={$result->msg_id}' class='w3-text-red  '><span>Delete</span></a>        
                        </span>
                        </a> 
                    <br>
                    <span class='w3-text-green p-1'>OOO</span>
                    <a Style='color:black' href='/model/readEmailProcess.php?id={$result->msg_id}'>
                         <span class='w3-text-gray'>{$result->msg_subject}</span>
                    </a>
