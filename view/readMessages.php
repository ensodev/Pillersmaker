...
checkNotSession();
require_once  __DIR__ .'/../model/loadReadMsgProcess.php'; 
?>
<script>
    title='Email Board';
    titleTag(title);  
            ...
            foreach ($results as $result){
                ...
                <div class='w3-white'>
                    ...
                    <span>
                        ...
                        echo"</small></span>
                        <a href='/model/markMessageUnreadProcess.php?id= {$result->msg_id}'class='w3-text-grean'>
                        <span class='btn-sm'>Mark Unread</span>
                        </a>
                        
                        <a href='/model/deleteMessageProcess.php?id={$result->msg_id}' class='w3-text-red '>                   <span class='w3-text-danger btn-sm'>Delete</span>
                        </a>                   
                    </span>
                    
                    <br>
                    <span class='w3-text-green p-1'>OOO</span>
                    <a href='/model/readEmailProcess.php?id={$result->msg_id}'  class='w3-text-green p-1'>
