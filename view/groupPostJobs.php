...
if(!isset($_SESSION)){
  ...
  require_once __DIR__ . '/../pagination/paginationJobs.php';
...
<div class="container mb-3">
  ...
  <div class="row text-center">
    ...
    <div class="col-md-10 mt-3 w3-green p-3 text-right " id="styles">
      ...
      <span class=" w3-text-amber">OOO</span>Merge Jobs</h5>
     ...
     <?php require_once __DIR__ . '/../advert/advert1.php';?>
      ...
      require_once  __DIR__ . '/../pagination/paginationFooterAllJobs.php';
