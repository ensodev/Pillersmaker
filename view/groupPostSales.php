...
if(!isset($_SESSION)){
  ...
  require_once __DIR__ . '/../pagination/paginationsales.php';
...
<script>
    title='products and services on pillersmaker';
    titleTag(title); 
</script>
...
<div class="container mb-3">
  ...
  <div class="row text-center">
    ...
    <div class="col-md-10 mt-3 w3-green p-3 text-right " id="styles">
      ...
      <span class=" w3-text-amber">OOO</span> Merge Shop</h5>
     ...
     <div class="mt-3 mb-2  mr-3">
      ...
      foreach ($rows as $row ) {
        echo "
          <div class='alert w3-white w3-text-green text-left p-1 pl-3 mb-3 ml-3 mr-3'>
            <div class='row'>
            <div class='col-md-1'>
      ...
      require_once  __DIR__ . '/../pagination/paginationFooterAllSales.php';
