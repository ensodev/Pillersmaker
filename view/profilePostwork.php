...
?>
 ...
 <?php require_once  __DIR__ .'/../model/profileMyPosts.php';?>
 ...
 ?>
 <?php $user_name = $_GET['PostUserName'] ; ?>
     ...
     <div class="row mt-3 text-center">
         ...
         <div class="col-md-10 w3-green mt-2 mb-4 pt-3 pb-3 " style="opacity:0.8; border-radius:2px">
             ...
             <?php
                 ...
                 <div class="text-right">
                 <?php
                     require_once  __DIR__ . '/../pagination/paginationFooterProfileMyPosts.php';
                 ?>
                 <div>
