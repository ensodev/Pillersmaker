...
<?php 
if(isset($_GET)){
    require_once __DIR__ . '/../model/searchProfileGET.php';
}else{
    exit();
}
        ...
        <div class="col-md-8 w3-green mt-2 mb-4 pt-3 pb-3 " style="opacity:0.8; border-radius:2px">
            ...
            <div class="card">
                <div class="card-header w3-green text-right">
                    ...
                    <a href="/view/profilePostwork.php?profilePosts=<?php echo $getResult->id ;?>&PostUserName=<?php echo $getResult->user_name;?>" class="btn btn-success" style="border:1px white solid">
                    ...
                    <a href="/view/picturepage.php?pic=
                        <?php echo trim($result->profile_pic) ; ?>&id=
                           <?php echo trim($getResult->id) ;?>">
                    <img src="../upload/<?php echo $result->profile_pic ; ?>" style="width:150px; height:150px; border-radius:5px" class="mb-3 mt-3  w3-animate-right">
                    </a>
                    
                  <h6><span class="w3-text-yellow ">OOO </span><?php echo $getResult->user_name.' ' ;?><span class="w3-text-yellow"> OOO</h6>
                  ...
                  <?php 
                       ...
                       ?>
                        ...
                        <a class='connection-menu btn' 
                                href='/model/connectFriend.php?id=<?php echo $_SESSION['USER_ID'] ;?>
                                      &friend_id=<?php echo $getResult->id;?>'><span>
                    ...
                    </span> <a href='/view/compose.php?profileName=$getResult->user_name'class='btn w3-amber'>Message</a>

                    <div class='mt-2 mb-3'>
                      <a  href='/view/reportMembers.php?reportMem=$getResult->user_name' class='menu w3-brown'>Report</a>

                      <a href='/model/disconnectFriend.php?id=$userID&friend_id=$getResult->id' class='menu w3-brown'>Disconnect</a>
                      
                      <a  href='../model/dislike.php?id=$getResult->id' class='menu w3-brown'>Dislike</a>
                    ...
                    <div class='mt-2'>
                      ...
                      <a  href='/model/disconnectFriend.php?id=$userID&friend_id=$getResult->id' class='menu w3-brown'>Cancel Request</a>
                      <a  href='../model/dislike.php?id=$getResult->id' class='menu w3-brown'>Dislike</a>
                    </div>";
                    }
                    ?>
                ...
                <div class="card-body w3-text-amber text-left">
                    ...
                    <div class="text-dark">
                        ...
                        <p ><?php echo $getResult->full_name;?></p>
                        <hr>
...
<div class="card-body w3-text-amber text-left">
                    ...
                    <div class=" text-dark">
                        ...
                        <p class="">
                            <h5 class="text-success">Main Talent:</h5> <?php echo $result->main_talent;?>
                        </p>
                        <hr>
                        <p class="">
                        <h5 class="text-success">Second Talent:</h5> <?php echo $result->second_talent;?>
                        </p>
...
<div class="card-body w3-text-black text-left">
                    ...
                    <?php
                        ...
                        <hr>
                          ...
                          <h5 class="text-success"> Website:</h5> <a href='<?php echo $result->website ;?>'><?php echo $result->website ;?></a>
                        
                        <hr>
                        
                            <h5 class="text-success">Email</h5><a href="mailto:<?php echo $result->email;?>"> <?php echo $result->email;?></a> 
                          
                        
                        <hr>
                        
                          <h5 class="text-success"> Moble:</h5><a href="tel:<?php echo $result->mobile;?>"> <?php echo $result->mobile;?></a> 
                ...
                <div class="card-footer w3-green text-center">
                    <div class="row mt-2 mb-2">
                        ...
                        <?php    
                        if($Like == false ){
                           echo " <a href='../model/like.php?id=$getResult->id'>
                                <span class='like-menu btn'>
                                
                                    Like $getResult->user_name
                                    <span class='badge w3-green' style='border:1px solid red'>$resultPrfileCount
                                    </span >";
                        }else{
                            
                           echo" <span class='like-menu btn'>
                                <span class='badge w3-green'>$resultPrfileCount
                                </span >
                                You Liked $getResult->user_name
                                ";
